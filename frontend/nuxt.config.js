...
export default {
  ...
  */
  head: {
    ...
    link:[
      ...
      {href:"https://fonts.googleapis.com/css?family=Muli:200,300,400,700", rel:"stylesheet"},
      {href:"https://fonts.googleapis.com/css?family=Comfortaa:200,300,400,700", rel:"stylesheet"}
    ] ,
    script:[      
  ...
  */
  css: [    
    ...
    '@/assets/css/theme_1590869380461.css'
  ],
  /*
